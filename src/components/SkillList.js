...
import { List, ListItem, ListIcon, Container, Box } from "@chakra-ui/react";
    ...
    <section className="skill-list">
      ...
      <div className="row">
        <div className="col-md-10 mx-auto">
          {/* Tech Skills*/}
          <h3>Tech Skills</h3>
          <Container maxW="2xl" centerContent={true}>
            <Box padding="4" maxW="md">
              <List spacing={3}>
                <ListItem>
                  <ListIcon as={ImSmile2} color="green.500" />
                  Front-End Development: React.js, Redux, Redux-Saga, CSS3,
                  Sass, Less, HTML5, Pug(Jade), JavaScript, AJAX, React Context
                  API, React Hooks, Ant.design, Bootstrap, Materialize, Semantic
                  UI, Responsive design, Webpack, ES6
                </ListItem>
                <ListItem>
